...
const QuickPacks = () => {
    const amazonCards = [
        {pic: '/images/amazon/amazon3.png', title: "Amazon beauty product pack", price: "$1,500", reducedPrice: "$1,080", credits: 15, top_level: {images: 13, videos: 4}, mid_level: {images: 20, videos: 8}, stan_level: {images: 35, videos: 12}},
